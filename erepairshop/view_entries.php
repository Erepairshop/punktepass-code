...
<body>
    ...
    function printEntry(data) {
        ...
        const musterHtml = data.muster_path
            ? `<div class="field"><span class="label">Entsperrmuster:</span><img src="/formular/${data.muster_path}" style="max-width: 150px; border: 1px solid #ddd; border-radius: 8px; margin-top: 8px;"></div>`
            : '';

        const pinHtml = data.pin
            ? `<div class="field"><span class="label">PIN:</span><span class="value highlight">${data.pin}</span></div>`
            : '';
        ...
        printWindow.document.write(`
            ...
            <head>
                <meta charset="UTF-8">
                <title>Reparaturauftrag - ${data.name}</title>
                <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    body {
                    ...
                    .header-info { text-align: right; font-size: 13px; color: #6b7280; }
                    .header-info strong { color: #1f2937; display: block; font-size: 14px; }
                    ...
                    .title p { font-size: 14px; opacity: 0.9; }
            ...
            <body>
                <div class="header">
                    <div class="logo">E<span>repairshop</span></div>
                    <div class="header-info">
                        <strong>Reparaturannahme</strong>
                        Siedlungsring 51<br>
                ...
                <div class="section">
                    ...
                    <div class="field">
                        ...
                        <span class="value highlight">${data.telefon}</span>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="field">
                        ...
                        <span class="value">${data.marke} ${data.modell}</span>
                    </div>
                    <div class="field">
                        <span class="label">Problem:</span>
                        <span class="value">${data.problem}</span>
                    </div>
                    ${data.other ? `<div class="field"><span class="label">Details:</span><span class="value">${data.other}</span></div>` : ''}
                    ${pinHtml}
                    ${musterHtml}
                </div>

                <div class="datenschutz">
                    <div class="datenschutz-title">🔒 Datenschutzhinweis (vom Kunden bestätigt)</div>
                    <div class="datenschutz-text">
                        Der Kunde hat der Verarbeitung folgender Daten zugestimmt:
                        <ul>
                            <li>Kontaktdaten zur Benachrichtigung über den Reparaturstatus</li>
                            <li>Geräteinformationen zur Durchführung der Reparatur</li>
                            <li>PIN/Entsperrmuster ausschließlich zur Funktionsprüfung nach der Reparatur</li>
                        </ul>
                        <strong>PIN/Muster wird nach Geräteabholung sofort gelöscht.</strong><br>
                        Vollständige Datenschutzerklärung: erepairshop.de/datenschutz
                    </div>
                </div>
                ...
                <div class="footer">
                    Erepairshop • info@erepairshop.de • erepairshop.de
                </div>
