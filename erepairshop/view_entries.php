...
$erledigtDatei = __DIR__ . '/erledigt_status.txt';
...
if (isset($_POST['ajax']) && $_POST['ajax'] === '1') {
    ...
    if (isset($_POST['markAllAsDone'])) {
        $eintraegeDatei = __DIR__ . '/entries.txt';
...
// Kommentare laden
$kommentarDatei = __DIR__ . '/kommentare.txt';
