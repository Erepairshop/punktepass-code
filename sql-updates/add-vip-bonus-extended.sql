...
ADD COLUMN IF NOT EXISTS vip_fix_bronze INT DEFAULT 1 COMMENT 'Fixed bonus points for Bronze',
ADD COLUMN IF NOT EXISTS vip_fix_silver INT DEFAULT 2 COMMENT 'Fixed bonus points for Silver',
ADD COLUMN IF NOT EXISTS vip_fix_gold INT DEFAULT 3 COMMENT 'Fixed bonus points for Gold',
ADD COLUMN IF NOT EXISTS vip_fix_platinum INT DEFAULT 5 COMMENT 'Fixed bonus points for Platinum';
...
ADD COLUMN IF NOT EXISTS vip_streak_bronze INT DEFAULT 1 COMMENT 'Streak bonus for Bronze',
ADD COLUMN IF NOT EXISTS vip_streak_silver INT DEFAULT 2 COMMENT 'Streak bonus for Silver',
ADD COLUMN IF NOT EXISTS vip_streak_gold INT DEFAULT 3 COMMENT 'Streak bonus for Gold',
ADD COLUMN IF NOT EXISTS vip_streak_platinum INT DEFAULT 5 COMMENT 'Streak bonus for Platinum';
...
ADD COLUMN IF NOT EXISTS vip_daily_bronze INT DEFAULT 5 COMMENT 'Daily first scan bonus for Bronze',
