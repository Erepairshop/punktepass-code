...
window.PPV_TRANSLATIONS = window.PPV_TRANSLATIONS || {
  ...
  en: {
    welcome: "Welcome to PunktePass",
    points: "My Points",
    rewards: "Rewards",
    collect_here: "Collect points here",
    show_in_store: "Show your personal QR code in the store",
    show_qr: "Show QR Code",
    show_code_tip: "Show this code in the store to collect points.",
    qr_daily_warning: "Only 1 scan per store per day!",
    how_to_use: "How to use the code",
    qr_instruction_1: "1. Show this code to the cashier",
    qr_instruction_2: "2. They scan it with their terminal",
    qr_instruction_3: "3. You automatically collect points!",
    nearby: "Stores Near You",
    no_stores: "No stores found",
    route: "Route",
    open: "Open",
    closed: "Closed",
    dist_unknown: "Distance unknown",
    call: "Call",
    website: "Website",
    campaign: "Campaign",
    loading: "Loading...",
    ...
    rewards_preview: "x Rewards",
    campaigns_preview: "x Campaigns",
    gallery_label: "Gallery",
    reward_label_required: "Required:",
    reward_label_reward: "Reward:",
    reward_label_date: "Date:",
    reward_per_scan: "Per scan:",
    discount_percent_text: "% Discount",
    discount_fixed_text: "Discount",
    points_multiplier_text: "x Points",
    fixed_text: "Bonus",
    free_product_text: "Free Product",
    ...
    vip_title: "VIP Bonuses",
    vip_fix_title: "Fixed Points",
    vip_streak_title: "X. Scan",
    vip_daily_title: "First Scan",
    vip_bronze: "Bronze",
    vip_silver: "Silver",
    vip_gold: "Gold",
    ...
    vip_every: "Every",
    vip_scan: "scan",
    vip_double: "2x Points",
    vip_triple: "3x Points",
    qr_valid_for: "Valid for:",
    qr_expired: "QR code expired",
    qr_refresh: "Generate new QR code",
    qr_new_generated: "New QR code (30 min)",
    reward_valid_until: "Valid until:",
    points_unit: "Points",
    geo_denied_tip: "📍 Enable location for distances",
    location_from_address: "📍 Distance based on your address",
    add_address_tip: "📍 Add your address for distances",
    load_more_stores: "Load more stores",
    qr_loaded: "QR loaded",
    qr_min: "min",
    qr_offline_cached: "Offline - Cached QR code",
    qr_offline_static: "Offline - Daily QR (1x per store)",
    qr_offline_error: "Offline - Please connect to the internet once",
    rate_store: "Rate",
  }
};
  ...
  root.innerHTML = `
    <div class="ppv-dashboard-netto">
      <div class="ppv-dashboard-inner">
        ...
        <style>
          .ppv-btn-qr-floating { position:fixed; top:calc(var(--pp-header-height,64px) + env(safe-area-inset-top,0px) + 12px); left:0; right:0; margin:0 auto; width:fit-content; z-index:200; display:inline-flex; align-items:center; gap:8px; padding:12px 22px; background:linear-gradient(135deg,#6366f1,#8b5cf6); color:#fff; border:none; border-radius:999px; font-weight:700; font-size:14px; cursor:pointer; box-shadow:0 8px 24px rgba(99,102,241,.45); transition:transform .15s; }
