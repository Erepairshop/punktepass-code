...
const PPV_TRANSLATIONS = {
  de: {
    ...
    vip_how_it_works: "So funktioniert's",
    vip_step1: "Sammle Punkte durch regelmäßige QR-Code Scans bei teilnehmenden Geschäften",
    vip_step2: "Dein VIP-Level steigt automatisch mit deinen Gesamtpunkten (Bronze ab 100, Silber ab 500, Gold ab 1000, Platin ab 2000)",
    vip_step3: "Je höher dein Level, desto mehr Bonuspunkte bekommst du bei jedem Scan!",
  ...
  hu: {
    ...
    vip_double: "2x Pont",
    vip_triple: "3x Pont",
    vip_how_it_works: "Így működik",
    vip_step1: "Gyűjts pontokat rendszeres QR-kód beolvasással a résztvevő üzletekben",
    vip_step2: "A VIP szinted automatikusan emelkedik az összpontjaiddal (Bronz 100-tól, Ezüst 500-tól, Arany 1000-től, Platina 2000-től)",
    vip_step3: "Minél magasabb a szinted, annál több bónuszpontot kapsz minden beolvasásnál!",
  ...
  ro: {
    ...
    vip_how_it_works: "Cum funcționează",
    vip_step1: "Colectează puncte prin scanarea codului QR la magazinele participante",
    vip_step2: "Nivelul tău VIP crește automat odată cu punctele totale (Bronz de la 100, Argint de la 500, Aur de la 1000, Platină de la 2000)",
    vip_step3: "Cu cât nivelul este mai mare, cu atât mai multe puncte bonus primești la fiecare scanare!",
