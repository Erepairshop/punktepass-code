...
class PPV_Discover {
  public static function hooks(){ add_action('init',[__CLASS__,'rewrite']); add_action('template_redirect',[__CLASS__,'render']); }
  public static function rewrite(){ add_rewrite_rule('^discover/?$', 'index.php?ppv_discover=1', 'top'); add_rewrite_tag('%ppv_discover%', '1'); }
