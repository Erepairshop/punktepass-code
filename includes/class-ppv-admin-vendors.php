...
class PPV_Admin_Vendors {
    ...
    public static function add_admin_menu() {
        add_menu_page(
            ...
            'PunktePass Händler',
            'manage_options',
            'ppv-haendler-admin', // 🔹 új, egyedi slug
...
wp_add_inline_script('ppv-admin-vendors', "window.ppvAdminVendors = {$__json};", 'before');
    }

    /** ============================================================
     *  ADMIN OLDAL MEGJELENÍTÉS
     *  ============================================================ */
    public static function render_admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1>PunktePass — Händler Verwaltung</h1>
            <p>Hier können Sie POS aktivieren, PIN generieren oder deaktivieren.</p>
            ...
            <table class="widefat fixed striped">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo intval($r->active) === 1 
                                    ? '<span style="color:#00cc66;font-weight:600;">✅ Aktiv</span>'
                                    : '<span style="color:#cc0000;font-weight:600;">❌ Inaktiv</span>'; ?>
                            </td>
                            <td><?php echo $r->pos_enabled ? '✅' : '—'; ?></td>
                            <td style="font-weight:600;color:#d63384;">
                                <?php echo $r->pos_pin ? esc_html($r->pos_pin) : '—'; ?>
                            </td>
                            <td>
                    ...
                    <?php endforeach; else: ?>
                        <tr><td colspan="7">Keine Händler gefunden.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
public static function ajax_force_activate() {
    ...
    // 🔹 Ha van e-mail, megpróbáljuk a WordPress felhasználót megtalálni
    ...
    // 🔹 Store frissítése – user_id csak akkor, ha találtunk
    $update_data = [
    ...
    if ($updated !== false) {
        $msg = $user_id > 0
            ...
            : "Store aktiviert (ohne Benutzer-Verknüpfung)";
...
/** ============================================================
 *  STABIL INIT (POS LOG STRUKTÚRA SZERINT)
 *  ============================================================ */
