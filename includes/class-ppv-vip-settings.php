    ...
    public static function render_settings_page($atts = []) {
        ...
        $T = [
            'de' => [
                ...
                'how_step1' => 'Jeder Kunde baut sein VIP-Level separat bei DIR auf – durch wiederholte QR-Code Scans in DEINEM Geschäft',
                'how_step2' => 'Das VIP-Level basiert auf der Anzahl der Scans BEI DIR (Bronze ab 25, Silber ab 50, Gold ab 75, Platin ab 100 Scans)',
                'how_step3' => 'Die hier eingestellten Boni gelten NUR in deinem Geschäft – je höher das Level bei dir, desto mehr Bonuspunkte!',
            ...
            'hu' => [
                ...
                'how_step1' => 'Minden vásárló külön építi a VIP szintjét NÁLAD – ismételt QR-kód beolvasásokkal a TE üzletedben',
                'how_step2' => 'A VIP szint a NÁLAD végzett scanelések száma alapján alakul (Bronz 25-től, Ezüst 50-től, Arany 75-től, Platina 100-tól)',
                'how_step3' => 'Az itt beállított bónuszok CSAK a te üzletedben érvényesek – minél magasabb a szint nálad, annál több bónuszpont!',
            ...
            'ro' => [
                ...
                'how_step1' => 'Fiecare client își construiește nivelul VIP separat LA TINE – prin scanări repetate ale codului QR în magazinul TĂU',
                'how_step2' => 'Nivelul VIP se bazează pe numărul de scanări LA TINE (Bronz de la 25, Argint de la 50, Aur de la 75, Platină de la 100)',
                'how_step3' => 'Bonusurile setate aici se aplică DOAR în magazinul tău – cu cât nivelul e mai mare la tine, cu atât mai multe puncte bonus!',
