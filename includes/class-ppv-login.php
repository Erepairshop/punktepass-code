...
public static function render_landing_page($atts) {
        ...
        <div class="lo-page">
            ...
            <!-- App Download Modal eltavolitva 2026-04-26 (user kerese) -->
            <!-- A also lo-pwa-banner marad: Android -> Google Play, iOS -> App Store ->
            ...
            <!-- App Install Banner (Android: Google Play, iOS: App Store) -->
            <div id="ppv-pwa-banner" class="lo-pwa-banner" style="display:none;">
                <div class="lo-pwa-inner">
                    ...
                    <div class="lo-pwa-text">
                        <strong id="ppv-pwa-banner-title"><?php echo PPV_Lang::t('login_pwa_banner_title', 'PunktePass App auf Google Play'); ?></strong>
        ...
        (function() {
            ...
            // Banner platform-aware: iOS -> App Store, Android -> Google Play
            const bannerInstall = document.getElementById('ppv-pwa-banner-install');
            const bannerTitle = document.getElementById('ppv-pwa-banner-title');
            if (bannerInstall && bannerTitle) {
                if (isIOS && !isStandalone) {
                    bannerInstall.href = 'https://apps.apple.com/app/punktepass/id6755680197';
                    bannerInstall.textContent = 'App Store';
                    bannerTitle.textContent = 'PunktePass im App Store';
                }
            }

            // Show install banner (Android OR iOS), not standalone, not dismissed) after 1.5s
            if ((isAndroid || isIOS) && !isStandalone && !bannerDismissed && pwaBanner) {
                setTimeout(() => {
        ...
        // App Download Modal Handler eltavolitva 2026-04-26 (modal kiszedve)
        </script>
