...
echo '          </div>
    ...
    <div class="ra-modal" style="max-width:600px">
        ...
        // New Ankauf Modal (Kaufvertrag - buying from customer)
        echo '<div class="ra-modal-overlay" id="ra-new-ankauf-modal">
    <div class="ra-modal" style="max-width:700px;max-height:90vh;overflow-y:auto">
        <h3 style="color:#b45309"><i class="ri-shopping-basket-line"></i> Neuer Ankauf (Kaufvertrag)</h3>
        <p class="ra-modal-sub">Ger&auml;t vom Kunden ankaufen</p>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px">
            <!-- Verk&auml;ufer (Customer) -->
            <div style="background:#fef3c7;border:1px solid #fcd34d;border-radius:10px;padding:16px">
                <h4 style="font-size:13px;color:#92400e;margin:0 0 12px;display:flex;align-items:center;gap:6px"><i class="ri-user-line"></i> Verk&auml;ufer</h4>
                <div class="field" style="margin-bottom:10px">
                    <label style="font-size:11px;color:#78350f">Name *</label>
                    <input type="text" id="ra-ank-seller-name" class="ra-input" placeholder="Max Mustermann" required>
                </div>
                <div class="field" style="margin-bottom:10px">
                    <label style="font-size:11px;color:#78350f">Stra&szlig;e</label>
                    <input type="text" id="ra-ank-seller-address" class="ra-input" placeholder="Musterstra&szlig;e 1">
                </div>
                <div style="display:grid;grid-template-columns:80px 1fr;gap:8px;margin-bottom:10px">
                    <div class="field">
                        <label style="font-size:11px;color:#78350f">PLZ</label>
                        <input type="text" id="ra-ank-seller-plz" class="ra-input" placeholder="12345">
                    </div>
                    <div class="field">
                        <label style="font-size:11px;color:#78350f">Stadt</label>
                        <input type="text" id="ra-ank-seller-city" class="ra-input" placeholder="Berlin">
                    </div>
                </div>
                <div class="field" style="margin-bottom:10px">
                    <label style="font-size:11px;color:#78350f">Telefon</label>
                    <input type="text" id="ra-ank-seller-phone" class="ra-input" placeholder="+49...">
                </div>
                <div class="field" style="margin-bottom:10px">
                    <label style="font-size:11px;color:#78350f">E-Mail</label>
                    <input type="email" id="ra-ank-seller-email" class="ra-input" placeholder="email@example.de">
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
                    <div class="field">
                        <label style="font-size:11px;color:#78350f">Ausweis-Typ</label>
                        <select id="ra-ank-seller-id-type" class="ra-input">
                            <option value="personalausweis">Personalausweis</option>
                            <option value="reisepass">Reisepass</option>
                        </select>
                    </div>
                    <div class="field">
                        <label style="font-size:11px;color:#78350f">Ausweis-Nr.</label>
                        <input type="text" id="ra-ank-seller-id-number" class="ra-input" placeholder="L01X...">
                    </div>
                </div>
            </div>
            ...
            <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:10px;padding:16px">
                <h4 style="font-size:13px;color:#0369a1;margin:0 0 12px;display:flex;align-items:center;gap:6px"><i class="ri-smartphone-line"></i> Ger&auml;t</h4>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px">
                    <div class="field">
                        <label style="font-size:11px;color:#075985">Marke</label>
                        <input type="text" id="ra-ank-device-brand" class="ra-input" placeholder="Apple">
                    </div>
                    <div class="field">
                        <label style="font-size:11px;color:#075985">Modell</label>
                        <input type="text" id="ra-ank-device-model" class="ra-input" placeholder="iPhone 13">
                    </div>
                </div>
                <div class="field" style="margin-bottom:10px">
                    <label style="font-size:11px;color:#075985;font-weight:600">IMEI *</label>
                    <input type="text" id="ra-ank-device-imei" class="ra-input" placeholder="359876543210987" style="font-family:monospace;font-weight:600">
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px">
                    <div class="field">
                        <label style="font-size:11px;color:#075985">Farbe</label>
                        <input type="text" id="ra-ank-device-color" class="ra-input" placeholder="Schwarz">
                    </div>
                    <div class="field">
                        <label style="font-size:11px;color:#075985">Zustand</label>
                        <select id="ra-ank-device-condition" class="ra-input">
                ...
                <div class="field" style="margin-bottom:10px">
                    <label style="font-size:11px;color:#075985">Zubeh&ouml;r</label>
                    <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px">
                        <label style="display:flex;align-items:center;gap:4px;font-size:11px;background:#e0f2fe;padding:4px 8px;border-radius:6px;cursor:pointer">
                            <input type="checkbox" class="ra-ank-accessory" value="ladekabel"> Ladekabel
                        </label>
                        <label style="display:flex;align-items:center;gap:4px;font-size:11px;background:#e0f2fe;padding:4px 8px;border-radius:6px;cursor:pointer">
                            <input type="checkbox" class="ra-ank-accessory" value="netzteil"> Netzteil
                        </label>
                        <label style="display:flex;align-items:center;gap:4px;font-size:11px;background:#e0f2fe;padding:4px 8px;border-radius:6px;cursor:pointer">
                            <input type="checkbox" class="ra-ank-accessory" value="originalverpackung"> OVP
                        </label>
                        <label style="display:flex;align-items:center;gap:4px;font-size:11px;background:#e0f2fe;padding:4px 8px;border-radius:6px;cursor:pointer">
                            <input type="checkbox" class="ra-ank-accessory" value="rechnung"> Rechnung
                        </label>
                    </div>
                </div>
                <div class="field">
                    <label style="font-size:11px;color:#075985">Hinweise</label>
                    <textarea id="ra-ank-device-notes" class="ra-input" rows="2" placeholder="Display-Kratzer, Akku 85%..."></textarea>
                </div>
            </div>
        </div>

        <!-- Preis -->
        <div style="background:linear-gradient(135deg,#fef3c7,#fde68a);border-radius:12px;padding:20px;text-align:center;margin-bottom:20px">
            <label style="font-size:13px;color:#92400e;font-weight:600;display:block;margin-bottom:8px">Ankaufspreis *</label>
            <div style="display:flex;align-items:center;justify-content:center;gap:8px">
                <input type="number" id="ra-ank-price" class="ra-input" step="0.01" min="0" placeholder="0.00" style="font-size:28px;font-weight:bold;text-align:center;max-width:200px;background:#fff">
                <span style="font-size:28px;font-weight:bold;color:#92400e">&euro;</span>
            </div>
            <div style="margin-top:12px">
                <label style="font-size:12px;color:#78350f">Zahlungsart:</label>
                <select id="ra-ank-payment" class="ra-input" style="width:auto;margin-left:8px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px">
            <div>
                <label style="font-size:11px;color:#6b7280;display:block;margin-bottom:6px">Unterschrift Verk&auml;ufer</label>
                <div style="background:#fff;border:2px solid #667eea;border-radius:8px;height:100px;position:relative">
                    <canvas id="ra-ank-seller-sig" width="280" height="96" style="width:100%;height:100%;cursor:crosshair"></canvas>
                </div>
                <button type="button" class="ra-btn ra-btn-outline ra-btn-sm" style="margin-top:6px" onclick="clearAnkaufSig(\'seller\')">
                    <i class="ri-eraser-line"></i> L&ouml;schen
                </button>
            </div>
            <div>
                <label style="font-size:11px;color:#6b7280;display:block;margin-bottom:6px">Unterschrift K&auml;ufer (H&auml;ndler)</label>
                <div style="background:#fff;border:2px solid #667eea;border-radius:8px;height:100px;position:relative">
                    <canvas id="ra-ank-buyer-sig" width="280" height="96" style="width:100%;height:100%;cursor:crosshair"></canvas>
                </div>
                <button type="button" class="ra-btn ra-btn-outline ra-btn-sm" style="margin-top:6px" onclick="clearAnkaufSig(\'buyer\')">
                    <i class="ri-eraser-line"></i> L&ouml;schen
                </button>
            </div>
        </div>
        ...
        <div style="display:flex;gap:10px">
            <button type="button" class="ra-btn ra-btn-outline" style="flex:1" id="ra-ank-cancel">Abbrechen</button>
            <button type="button" class="ra-btn" style="flex:2;background:#b45309;color:#fff" id="ra-ank-submit">
                <i class="ri-file-text-line"></i> Kaufvertrag erstellen
            </button>
        </div>
    </div>
</div>';
...
(function(){
    ...
    /* ===== ANKAUF MODAL ===== */
    var ankModal=document.getElementById("ra-new-ankauf-modal");
    var ankSellerCtx=null,ankBuyerCtx=null,ankDrawing=false;

    document.getElementById("ra-new-ankauf-btn").addEventListener("click",function(){
        clearAnkaufForm();
        ankModal.classList.add("show");
        initAnkaufSignatures();
    });
    document.getElementById("ra-ank-cancel").addEventListener("click",function(){
        ankModal.classList.remove("show");
    });
    ankModal.addEventListener("click",function(e){
        if(e.target===ankModal)ankModal.classList.remove("show");
    });

    function clearAnkaufForm(){
        document.getElementById("ra-ank-seller-name").value="";
        document.getElementById("ra-ank-seller-address").value="";
        document.getElementById("ra-ank-seller-plz").value="";
        document.getElementById("ra-ank-seller-city").value="";
        document.getElementById("ra-ank-seller-phone").value="";
        document.getElementById("ra-ank-seller-email").value="";
        document.getElementById("ra-ank-seller-id-type").value="personalausweis";
        document.getElementById("ra-ank-seller-id-number").value="";
        document.getElementById("ra-ank-device-brand").value="";
        document.getElementById("ra-ank-device-model").value="";
        document.getElementById("ra-ank-device-imei").value="";
        document.getElementById("ra-ank-device-color").value="";
        document.getElementById("ra-ank-device-condition").value="gut";
        document.getElementById("ra-ank-device-notes").value="";
        document.getElementById("ra-ank-price").value="";
        document.getElementById("ra-ank-payment").value="bar";
        document.querySelectorAll(".ra-ank-accessory").forEach(function(cb){cb.checked=false;});
    }

    function initAnkaufSignatures(){
        var sellerCanvas=document.getElementById("ra-ank-seller-sig");
        var buyerCanvas=document.getElementById("ra-ank-buyer-sig");
        ankSellerCtx=sellerCanvas.getContext("2d");
        ankBuyerCtx=buyerCanvas.getContext("2d");
        ankSellerCtx.clearRect(0,0,sellerCanvas.width,sellerCanvas.height);
        ankBuyerCtx.clearRect(0,0,buyerCanvas.width,buyerCanvas.height);
        ankSellerCtx.strokeStyle="#1f2937";ankSellerCtx.lineWidth=2;ankSellerCtx.lineCap="round";
        ankBuyerCtx.strokeStyle="#1f2937";ankBuyerCtx.lineWidth=2;ankBuyerCtx.lineCap="round";

        function setupCanvas(canvas,ctx){
            var draw=false,lastX=0,lastY=0;
            function getPos(e){
            ...
            canvas.onmousedown=canvas.ontouchstart=function(e){
                e.preventDefault();draw=true;var p=getPos(e);lastX=p.x;lastY=p.y;
            };
            ...
            canvas.onmouseup=canvas.ontouchend=canvas.onmouseleave=function(){draw=false;};
        }
        setupCanvas(sellerCanvas,ankSellerCtx);
        setupCanvas(buyerCanvas,ankBuyerCtx);
    }

    window.clearAnkaufSig=function(which){
        var canvas=document.getElementById("ra-ank-"+(which==="seller"?"seller":"buyer")+"-sig");
        var ctx=which==="seller"?ankSellerCtx:ankBuyerCtx;
        if(ctx)ctx.clearRect(0,0,canvas.width,canvas.height);
    };

    document.getElementById("ra-ank-submit").addEventListener("click",function(){
        var name=document.getElementById("ra-ank-seller-name").value.trim();
        var price=parseFloat(document.getElementById("ra-ank-price").value)||0;
        if(!name){toast("Verkäufer-Name ist erforderlich");return;}
        if(price<=0){toast("Ankaufspreis ist erforderlich");return;}

        var accessories=[];
        document.querySelectorAll(".ra-ank-accessory:checked").forEach(function(cb){accessories.push(cb.value);});

        var sellerSig=document.getElementById("ra-ank-seller-sig").toDataURL("image/png");
        var buyerSig=document.getElementById("ra-ank-buyer-sig").toDataURL("image/png");

        var fd=new FormData();
        fd.append("action","ppv_repair_ankauf_create");
        fd.append("nonce",NONCE);
        fd.append("seller_name",name);
        fd.append("seller_address",document.getElementById("ra-ank-seller-address").value);
        fd.append("seller_plz",document.getElementById("ra-ank-seller-plz").value);
        fd.append("seller_city",document.getElementById("ra-ank-seller-city").value);
        fd.append("seller_phone",document.getElementById("ra-ank-seller-phone").value);
        fd.append("seller_email",document.getElementById("ra-ank-seller-email").value);
        fd.append("seller_id_type",document.getElementById("ra-ank-seller-id-type").value);
        fd.append("seller_id_number",document.getElementById("ra-ank-seller-id-number").value);
        fd.append("device_brand",document.getElementById("ra-ank-device-brand").value);
        fd.append("device_model",document.getElementById("ra-ank-device-model").value);
        fd.append("device_imei",document.getElementById("ra-ank-device-imei").value);
        fd.append("device_color",document.getElementById("ra-ank-device-color").value);
        fd.append("device_condition",document.getElementById("ra-ank-device-condition").value);
        fd.append("device_accessories",JSON.stringify(accessories));
        fd.append("device_notes",document.getElementById("ra-ank-device-notes").value);
        fd.append("ankauf_price",price);
        fd.append("payment_method",document.getElementById("ra-ank-payment").value);
        fd.append("seller_signature",sellerSig);
        fd.append("buyer_signature",buyerSig);

        var btn=document.getElementById("ra-ank-submit");
        btn.disabled=true;btn.innerHTML=\'<i class="ri-loader-4-line ri-spin"></i> Wird erstellt...\';

        fetch(AJAX,{method:"POST",body:fd,credentials:"same-origin"})
        .then(function(r){return r.json()})
        .then(function(data){
            btn.disabled=false;btn.innerHTML=\'<i class="ri-file-text-line"></i> Kaufvertrag erstellen\';
            if(data.success){
                toast("Ankauf "+data.data.ankauf_number+" erstellt!");
                ankModal.classList.remove("show");
                // Open PDF
                window.open(AJAX+"?action=ppv_repair_ankauf_pdf&nonce="+NONCE+"&ankauf_id="+data.data.ankauf_id,"_blank");
            }else{
                toast(data.data&&data.data.message?data.data.message:"Fehler beim Erstellen");
            }
        })
        .catch(function(){
            btn.disabled=false;btn.innerHTML=\'<i class="ri-file-text-line"></i> Kaufvertrag erstellen\';
