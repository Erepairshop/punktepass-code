...
'rewards_form_points_given' => 'Pont / scan',
'rewards_form_points_given_placeholder' => 'pl. 2',
'rewards_form_points_given_helper' => 'Ennyi pontot kap a vendég minden scanneléskor',
'rewards_filiale_points_locked' => 'Ez az érték a főüzlettől (%s) származik. Változtatás csak ott lehetséges.',
...
'rewards_form_free_product_helper' => 'Az ingyenes termék neve',
...
'qs_rewards' => 'Jutalmak',
'csv_today' => 'Ma',
'csv_date' => 'Dátum választás',
'csv_month' => 'Ez a hónap',
'minimize' => 'Kicsinyítés',
'scanner_btn' => 'Szkenner',
't_col_time' => 'Idő',
...
'app_complete' => 'COMPLETE - Összes kód betöltve!',
    ...
    // Checkout page
    'checkout_title' => 'PunktePass Kereskedői Előfizetés',
    'checkout_page_title' => 'Előfizetés - PunktePass',
    'checkout_activate_for' => 'Aktiválja előfizetését: %s',
    'checkout_per_month' => 'havonta',
    'checkout_incl_vat' => '(19%% ÁFÁ-val)',
    'checkout_net_no_vat' => '(nettó, ÁFA nélkül)',
    'checkout_net_plus_vat' => '%s € nettó + %s € ÁFA',
    'checkout_no_vat_note' => 'Nincs ÁFA-felár a Németországon kívüli vállalkozások számára',
    ...
    'checkout_invoices' => 'Számlakészítés',
    'checkout_customer_mgmt' => 'Ügyfélkezelés',
    'checkout_email_notifications' => 'E-mail értesítések',
    'checkout_support' => 'Támogatás',
    'checkout_cancel_note' => 'Havonta lemondható - Előfizetését bármikor lemondhatja a hónap végére.',
    'checkout_pay_via_paypal' => 'Fizetés PayPal-lal',
    'checkout_paypal_desc' => 'Automatikus havi terhelés PayPal-on keresztül (bankkártyás fizetés is lehetséges)',
    'checkout_promo_title' => 'Van promóciós kódja?',
    'checkout_promo_placeholder' => 'Kód megadása...',
    'checkout_promo_redeem' => 'Beváltás',
    'checkout_promo_activate' => 'Ingyenes aktiválás',
    'checkout_promo_months_free' => '%d hónap ingyen!',
    'checkout_promo_activate_months' => '%d hónap ingyenes aktiválása',
    'checkout_promo_activating' => 'Aktiválás...',
    'checkout_promo_success' => 'Sikeresen aktiválva! Előfizetése %d hónapig ingyenes (eddig: %s). Átirányítás...',
    'checkout_promo_invalid' => 'Érvénytelen kód',
    'checkout_promo_error' => 'Hiba a beváltásnál.',
    'checkout_promo_network_error' => 'Hálózati hiba. Kérjük, próbálja újra.',
    'checkout_promo_check_error' => 'Ellenőrzési hiba. Kérjük, próbálja újra.',
    'checkout_terms' => 'Az előfizetéssel elfogadja',
    'checkout_terms_link' => 'ÁSZF',
    'checkout_terms_and' => 'és',
    'checkout_privacy_link' => 'Adatvédelmi nyilatkozat',
    'checkout_back' => 'Vissza a vezérlőpultra',
    'checkout_paypal_thanks' => 'Köszönjük!',
    ...
    // ============================================================
    'qr_admin_access_denied' => '❌ Hozzáférés megtagadva. Csak kereskedők és szkennerek számára.',
    'qr_admin_scanner_active' => 'Szkenner aktív...',
    'qr_admin_scanner_torch' => '🔦 Zseblámpa',
    'qr_admin_devices_title_text' => 'Regisztrált eszközök',
    'qr_admin_devices_subtitle_text' => 'Kezelje a szkennert használó eszközöket.',
    'qr_admin_devices_count_label' => 'Eszközök',
    'qr_admin_devices_info_text' => 'Új eszköz regisztrálásához kattintson a kívánt eszközön az "Eszköz regisztrálása" gombra.',
    'qr_admin_devices_current_text' => 'Jelenlegi eszköz',
    'qr_admin_devices_checking_text' => 'Eszközállapot ellenőrzése...',
    'qr_admin_devices_register_btn_text' => 'Eszköz regisztrálása',
    'qr_admin_devices_registered_badge_text' => 'Eszköz regisztrálva',
    'qr_admin_devices_request_approval_text' => 'Admin jóváhagyás kérése',
    'qr_admin_devices_request_slot_text' => 'További eszköz kérése',
    'qr_admin_devices_copy_link_text' => 'Új eszköz linkjének másolása',
    'qr_admin_devices_no_devices_text' => 'Még nincs regisztrált eszköz.',
    'qr_admin_devices_register_first_text' => 'Regisztrálja első eszközét a szkenner használatához.',
    'qr_admin_devices_current_badge_text' => 'Ez az eszköz',
    'qr_admin_users_title_text' => 'Szkenner-felhasználók',
    'qr_admin_users_add_btn_text' => 'Új szkenner létrehozása',
    'qr_admin_users_no_users_text' => 'Még nincs létrehozva szkenner-felhasználó.',
    'qr_admin_users_login_label' => 'E-mail vagy felhasználónév',
    'qr_admin_users_login_placeholder' => 'szkenner1 vagy szkenner@example.com',
    'qr_admin_users_password_placeholder' => 'Jelszó megadása',
    'qr_admin_campaigns_all_branches' => 'Minden fiók',
    'qr_admin_campaigns_type_free_product' => '🎁 Ingyenes termék',
    'qr_admin_campaigns_label_required_points' => 'Szükséges pontok',
    'qr_admin_campaigns_label_points_given' => 'Pontok szkennelésenként',
    'qr_admin_campaigns_label_free_product' => '🎁 Terméknév',
    'qr_admin_campaigns_placeholder_free_product' => 'pl. Kávé + sütemény',
    'qr_admin_campaigns_label_free_product_value' => 'Termékérték',
];
