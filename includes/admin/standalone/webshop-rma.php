    ...
    public static function render(): void {
        ...
        <?php else: ?>
            ...
            <div class="rma-list">
                ...
                <?php foreach ($shown as $rma): $status = sanitize_key($rma['status'] ?? 'pending'); ?>
